...
class ECdataset(InMemoryDataset):
    ...
    def process(self):
        ...
        #print(protFunct_) -- {'4p18.N': 310, '5oba.C': 310,..., '6h6u.A': 310}
        #print(type(protFunct_)) -- <class 'dict'>
        ...
        with warnings.catch_warnings():
            ...
            for fileIter, curFile in tqdm(enumerate(fileList_)):
                ...
                # curProtein.y -- tensor(195)
                # curProtein.x -- tensor([[ 7],[ 6],[14],[ 1],[19],[ 8],...[ 3]])    torch.Size([104, 1])
